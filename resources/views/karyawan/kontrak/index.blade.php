                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <a style="margin-left: 7.5%" title="TAMBAH KARYAWAN" href="{{route('createkaryawanKontrak')}}" name="submit"
                            ...
                            <div class="col-md-6">
                                <h4 style="margin-left: 54%"><b>Jumlah Karyawan :
                                        {{ $jumlah_pegawai }}<?php // $rowheader->jumlahkaryawan;
                                        ?></b></h4>
                            </div>
                            {{-- <?php }else{ ?> --}}
                            {{-- <div class="col-md-12">
                                        ...
                                        @foreach ($pegawai as $data)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a title="UBAH KARYAWAN" href="{{route('editkaryawanKontrak', $data->id)}}"><i class="material-icons" aria-hidden="true">edit</i></a>
                                                </td>
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>2008/12/11</td>
                                        <td>$136,200</td>
                                    </tr>http://127.0.0.1:8000/karyawanTetap
                                    <tr>
