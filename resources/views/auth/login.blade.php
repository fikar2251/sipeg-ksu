...
<body class="login-page">
    <div class="login-box">
     ...
     <!-- Bootstrap Core Js -->
     <script src="public/asset/plugins/bootstrap/js/bootstrap.js"></script>
 
     <!-- Waves Effect Plugin Js -->
     <script src="public/asset/plugins/node-waves/waves.js"></script>
 
     <!-- Validation Plugin Js -->
     <script src="public/asset/plugins/jquery-validation/jquery.validate.js"></script>
 
     <!-- Custom Js -->
     <script src="public/asset/js/admin.js"></script>
     <script src="public/asset/js/pages/examples/sign-in.js"></script>
</body>
