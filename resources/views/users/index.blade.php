        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <a style="margin-left: 7.5%" title="TAMBAH ROLE" href="javascript:void(0);" name="submit" class="btn btn-success waves-effect"><i class="material-icons">add</i><span>TAMBAH USER</span></a>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="width: 20%">
                                            <a title="UBAH ROLE" href="#"><i class="material-icons" aria-hidden="true">edit</i></a>
                                            <a title="HAPUS ROLE" href="#" role="button" class="hapusRole" data-id="" data-toggle="modal"><i class="material-icons" aria-hidden="true">delete</i></a>
                                        </td>
                                    </tr>   
                                    @endforeach
                                </tbody>
