...
<section class="content">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="width: 20%">
                                            <a class="editbtn" data-id="{{$item->id}}" title="UBAH PERMISSION" href="#" data-toggle="modal" data-target="#editModal"> <i class="material-icons " aria-hidden="true">edit</i></a>
                                            <a title="HAPUS PERMISSION" href="{{url('permissions/delete', $item->id)}}" role="button" class="hapusPermission" data-id="" data-toggle="modal"><i class="material-icons" aria-hidden="true">delete</i></a>
                                        </td>
                                    </tr>   
                                    @endforeach
                                </tbody>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Tambah Data Permission</h4>
                </div>
                <div class="modal-body">
                    <form method="POST" action="{{ route('input-permission') }}">
                        @csrf
                        <div class="row clearfix">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Edit Data Permission</h4>
                </div>
                <div class="modal-body">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="permissionName" class="form-control" name="name">
