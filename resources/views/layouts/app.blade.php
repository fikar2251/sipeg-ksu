...
<script src="{{asset('public/asset/plugins/jquery/jquery.min.js')}}"></script>
    ...
    <!-- Dropzone Plugin Js -->
    <script src="{{asset('public/asset/plugins/dropzone/dropzone.js')}}"></script>

    <!-- Bootstrap Colorpicker Js -->
    <script src="{{asset('public/asset/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.js')}}"></script>

    <!-- Input Mask Plugin Js -->
    <script src="{{asset('public/asset/plugins/jquery-inputmask/jquery.inputmask.bundle.js')}}"></script>

    <!-- Multi Select Plugin Js -->
    <script src="{{asset('public/asset/plugins/multi-select/js/jquery.multi-select.js')}}"></script>

    <!-- Jquery Spinner Plugin Js -->
    <script src="{{asset('public/asset/plugins/jquery-spinner/js/jquery.spinner.js')}}"></script>

    <!-- Bootstrap Tags Input Plugin Js -->
    <script src="{{asset('public/asset/plugins/bootstrap-tagsinput/bootstrap-tagsinput.js')}}"></script>

    <!-- noUISlider Plugin Js -->
    <script src="{{asset('public/asset/plugins/nouislider/nouislider.js')}}"></script>
    ...
    <script src="{{asset('public/asset/plugins/jquery-validation/additional-methods.js')}}"></script>

    <!-- JQuery Steps Plugin Js -->
    <script src="{{asset('public/asset/plugins/jquery-steps/jquery.steps.js')}}"></script>
    ...
    {{-- <script src="{{asset('public/asset/js/dell.js')}}"></script> --}}
    <script src="{{asset('public/asset/js/pages/tables/jquery-datatable.js')}}"></script>
    ...
    <!--<script type="text/javascript" src="{{asset('public/asset/plugins/autoformat/jquery-3.2.1.slim.min.js')}}"></script>-->
    {{-- <script type="text/javascript" src="{{asset('public/asset/plugins/autoformat/simple.money.format.js')}}"></script> --}}
    {{-- <script type="text/javascript">
